...
export default function Home() {
  ...
  return (
    <div className="-mt-10 pt-7 sm:p-10 pb-0 bg-gradient-to-br from-indigo-50 to-purple-50">
        <ToastContainer position="bottom-right" />
      <div className="container mx-auto px-4 py-12">
        <main className="flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="max-w-xl">
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 leading-tight">
              <span className="text-purple-600">Ace</span> your interviews with
              peer practice
            </h1>

            <p className="text-gray-700 mt-6 text-lg leading-relaxed">
              Connect with like-minded candidates and practice real interview
              questions over video chat in a supportive, collaborative
              environment.
            </p>
            ...
            <div className="mt-10 space-y-6">
              ...
              <div className="flex items-center space-x-2 text-sm text-gray-600">
                ...
                <span>Practice DSA & behavioral interviews</span>
              </div>
              <div className="flex items-center space-x-2 text-sm text-gray-600">
                <svg
                ...
                <span>Schedule mocks anytime</span>
              </div>
              <div className="flex items-center space-x-2 text-sm text-gray-600">
                <svg
                ...
                <span>Instantly invite friends</span>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative bg-white p-2 rounded-xl shadow-xl">
              <img
                src={homeImage}
                className="w-[18rem] sm:w-full h-auto max-w-md rounded-lg object-cover"
